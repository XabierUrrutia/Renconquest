...
public class UnitHUDManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // La unidad fue destruida sin deseleccionarse explícitamente - ocultar panel
    ...
    public void SeleccionarUnidad(UnitVeterancy unidad)
    {
        ...
        if (veteraniaSeleccionada != null)
        {
            ...
            // Configuraci�n de la Foto (Usando TU variable retratoCara)
